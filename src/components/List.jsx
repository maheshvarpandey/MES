...
function List() {
    ...
    return (
        <>
            <div className="w-full sm:px-6 pt-6">
                ...
                <div className="px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
                    <table className="w-full whitespace-nowrap">
                        ...
                        <tbody className="w-full">
                            <tr className="h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 hover:border-2 hover:border-indigo-400 hover:rounded-md border-b border-t border-gray-100">
                            ...
                            <tr className="h-20 text-sm leading-none text-gray-800 border-b  hover:border-2 hover:border-indigo-400 hover:rounded-lg border-t bg-white hover:bg-gray-100 border-gray-100">
                                <td className="pl-4 cursor-pointer">
                                    <div className="flex items-center">
                                        <div className="w-10 h-10">
